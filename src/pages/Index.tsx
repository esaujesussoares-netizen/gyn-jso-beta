        ...
        <div className="relative z-10 px-4 py-20 text-center text-white">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Gym <span className="bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">JS</span>
            </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Junte-se a milhares de pessoas que já estão alcançando seus objetivos com o Gym JS
            </p>
            <Button 
              variant="hero" 
              size="lg"
